...
\cs_generate_variant:Nn \_zqdict_header_render_elements:nn { nV, xV, fV }
    ...
    \bool_if:nT {
      ...
      \str_if_eq:VVTF \l_zqdict_current_section_str \l_zqdict_previous_section_str {
        ...
        \str_if_eq:VnTF \l_zqdict_previous_section_str {} {
          ...
          \_zqdict_header_render_elements:xV {
            \_zqdict_section_get_options:V \l_tmpa_tl
          } \l_zqdict_buffer_part_tl
          \tl_clear:N \l_zqdict_buffer_part_tl
...
\pagestyle{fancy}
\fancyhead[LO]{\small\leftmark\quad\ShowEntriesForPage{\value{page}}}
\fancyhead[RE]{\small\ShowEntriesForPage{\value{page}}\quad\leftmark}
...
\NewDocumentEnvironment{MainGroup}{m m}{
