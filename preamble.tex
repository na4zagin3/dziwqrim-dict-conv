...
% Source Han
% 
\setmainjfont{Source Han Serif CN}[JFM=CCT]
\setsansjfont{Source Han Sans CN}[JFM=CCT]

\newjfontfamily\fontMainJapn{Source Han Serif JP}[]
\newjfontfamily\fontSansJapn{Source Han Sans JP}[]
\newjfontfamily\fontMainKo{Source Han Serif KR}[]
\newjfontfamily\fontSansKo{Source Han Sans KR}[]
\newjfontfamily\fontMainHans{Source Han Serif CN}[JFM=CCT]
\newjfontfamily\fontSansHans{Source Han Sans CN}[JFM=CCT]
...
\NewDocumentEnvironment{RadicalIndex}{m}{
  ...
  \_zqdict_radical_index_preface_radical:n{匚\_zqdict_kanji_cdot: 匸}
  ...
  \_zqdict_radical_index_preface_radical:n{厶}
  ...
  \_zqdict_radical_index_preface_radical:n{夂\_zqdict_kanji_cdot: 夊}
  ...
  \_zqdict_radical_index_preface_radical:n{齊}
  ...
  \_zqdict_radical_index_preface_radical:n{龜}
...
\NewDocumentCommand{\ReadingSection}{m}{
  \begin{center}
    {\fReadingIndexLabel\textbf{\capitalisewords{#1}}}\label{index-reading-section-#1}
  \end{center}
  \str_clear:N \l_zqdict_index_subsection_label_str
}
