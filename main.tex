...
\newenvironment{Entry}[2]{%
  ...
  \makebox[0pt][l]{\raisebox{-1ex}[0pt][0pt]{%
      \hspace{\EntryDescriptionLineLength+0.2\EntryDescriptionLineHeight}\qrcode[height=0.8\EntryDescriptionLineHeight]{https://www.chise.org/ids-find?components=#2}}}%
  \phantomsection%
...
\newcommand{\SoundItem}[1]{\item[/\textsf{#1}/:]}

\newenvironment{Sense}{\begin{itemize}}{\end{itemize}}
\newcommand{\SenseItem}[1]{\item[\{\textbf{\textsf{#1}}\}:]}
