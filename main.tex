...
\newcommand{\SenseItem}[1]{\item[]{\fSemanticLabel\large\MakeUppercase{#1}:} }
...
\NewDocumentCommand{\SikrokEntry}{m o m m}{
  \noindent%
  \IfNoValueTF{#2}{%
    #1\hfill #3\hfill\pageref{entry-#4}%
  }{%
    #1\hfill #3（#2）\pageref{entry-#4}%
  }%
  \par
}
